#!/usr/bin/env python3
"""
Модель 3: Logistic Regression + RuBERT (базовый, без дообучения)
Эмбеддинги от RuBERT + логистическая регрессия
"""
...
print("=" * 60)
print(" МОДЕЛЬ 3: LOGREG + RuBERT (БАЗОВЫЙ)")
print("=" * 60)

# =================== 1. ЗАГРУЗКА ДАННЫХ ===================
print("\n Загрузка датасета...")

# Исправленный путь: поднимаемся на один уровень выше, в папку models_*
...
plt.title('Confusion Matrix: LogReg + RuBERT (base)')
plt.ylabel('True')

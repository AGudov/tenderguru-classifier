#!/usr/bin/env python3
"""
Инференс для полной нейросети RuBERT (finetuned) с сохранением результата в CSV
...
print("=" * 60)
print(" ИНФЕРЕНС: RuBERT (полная нейросеть, FINETUNED)")
print("=" * 60)
if test_mode:
...
# 2. Загрузка модели RuBERT (дообученная)
...
print(" RuBERT (finetuned) загружен")

#!/usr/bin/env python3
"""
Модель 5: CatBoost + RuBERT (базовый, без дообучения)
Эмбеддинги от базового RuBERT + градиентный бустинг (CatBoost)
"""
...
plt.title('Confusion Matrix: CatBoost + RuBERT (base)')
plt.ylabel('True')
